...
public class SalonRegister extends AppCompatActivity implements View.OnClickListener {
    ...
    public void register() {
        ...
        if (password.isEmpty() || passwd.length() < 4 || passwd.length() > 10 || !(passwd.equals(password))) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(SalonRegister.this);
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Intent profile = new Intent(SalonRegister.this,Salon.class);
                        startActivity(profile);
                        overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                    } else {
                        Toast.makeText(SalonRegister.this, "connection timeout, check your internet connection", Toast.LENGTH_LONG).show();
                        final ProgressDialog progressDialog = new ProgressDialog(SalonRegister.this);
                        progressDialog.dismiss();
                    }
                }
   ...
   @Override
    ...
    public void onClick(View v) {
        ...
        if (v == link_login){
                    finish();
            startActivity(new Intent(SalonRegister.this,SalonLogin.class));
                    overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                }
            }
